...
/// to provide additional capabilities (e.g., IAsCommEventContext for PLC read/write).
/// </summary>
...
/// <summary>
/// Event context with AsComm (PLC) capabilities.
/// Provides read and write access to PLC tags during event handling.
/// </summary>
public interface IAsCommEventContext : IEventContext
{
    /// <summary>
