...
/// <summary>
/// Event context implementation for AsComm (PLC) connections.
/// Provides read and write access to PLC tags during event handling.
/// </summary>
public class AsCommEventContext : IAsCommEventContext
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="AsCommEventContext"/> class.
    /// </summary>
    /// <param name="eventName">The name of the event.</param>
    /// <param name="connection">The AsComm connection.</param>
    public AsCommEventContext(string eventName, IAsCommConnection connection)
    {
        EventName = eventName;
    ...
    private static string GetConnectionName(IAsCommConnection connection)
    {
